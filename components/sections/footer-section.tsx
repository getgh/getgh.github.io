    ...
    >
      ...
      <div className="swiss-container relative z-10 py-20 md:py-32">
        <div className="flex flex-col items-center justify-center text-center w-full">
          ...
          {/* Email flip */}
          <div className="mt-12">
            <FlippingEmail email="akdr@yahoo.com" />
          </div>

          {/* Social links with magnetic effect */}
          <div className="mt-16 flex items-center gap-6 flex-wrap justify-center">
            {[
              { name: "GitHub", url: "https://github.com/getgh" },
              { name: "LinkedIn", url: "https://linkedin.com/in/afraeim" },
              { name: "Email", url: "mailto:akdr@yahoo.com" },
            ].map((social) => (
              <MagneticButton
                key={social.name}
                as="a"
        ...
        <div className="swiss-container">
          <div className="flex flex-col items-center justify-center gap-2 text-center">
            <p className="font-nohemi text-xs text-white/40">
              © {new Date().getFullYear()} Abdul Kader Afraeim. All rights reserved.
            </p>
            <p className="font-nohemi text-xs text-white/40">
              CS Student @ Georgia State University | AWS Certified Solutions Architect | Built with Next.js & TypeScript
            </p>
          </div>
        </div>
      </div>
